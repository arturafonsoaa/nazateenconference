        ...
        <div class="collapse navbar-collapse items-center" id="navbar-links">
            <ul class="navbar-nav flex flex-col pl-0 list-style-none mr-auto">
                <li class="nav-item p-2">
                    <a class="nav-link text-white hover:text-neon-pink" href="#">Sobre</a>
                </li>
                <li class="nav-item p-2">
                    <a class="nav-link text-white hover:text-neon-pink" href="#">Palestrantes</a>
                </li>
                <li class="nav-item p-2">
                    <a class="nav-link text-white hover:text-neon-pink" href="#">Programação</a>
                </li>
                <li class="nav-item p-2">
                    <a class="nav-link text-white hover:text-neon-pink" href="#">Patrocinadores</a>
                </li>
                <li class="nav-item p-2">
                    <a class="nav-link text-white hover:text-neon-pink" href="#">Inscrição</a>
                </li>
                <li class="nav-item p-2">
